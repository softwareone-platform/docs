...
<figure><img src="../../../.gitbook/assets/image (3) (1) (1).png" alt=""><figcaption><p>The Orders page in the platform.</p></figcaption></figure>

2.  Do one of the following:

    *   If the order is **Querying**, navigate to the **General** tab, where the partner relationship request URL is displayed. &#x20;

        <figure><img src="../../../.gitbook/assets/image (4) (1).png" alt=""><figcaption><p>The URL on the General tab within the order details page.</p></figcaption></figure>
    * If the order is in **Draft**, select **Edit** in the upper right. Then, on the **Select Items** page, select **Next** to see the relationship request URL.&#x20;
    ...
    <figure><img src="../../../.gitbook/assets/image (5) (1).png" alt=""><figcaption><p>The URL in the Select items step.</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/csp_process.png" alt=""><figcaption><p>The Process option on the order details page.</p></figcaption></figure>
