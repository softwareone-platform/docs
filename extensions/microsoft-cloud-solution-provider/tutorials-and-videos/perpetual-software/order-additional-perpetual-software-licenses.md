...
This tutorial will guide you through the process of creating a change order by adding a one-time item called _Windows Server 2025_.&#x20;
...
1. Locate the item (for example, _Windows Server 2025)._ If required, use the following filters:
   ...
   2.  Select **Add another condition** and then use the dropdown to make the following selections:
       ...
       <figure><img src="../../../../.gitbook/assets/image (2) (1) (1).png" alt=""><figcaption><p>Filter options in the grid</p></figcaption></figure>
