...
1. On the **Items** page, make sure that all subscriptions show the new quantity as 0. When done, select **Next**.
2. On the **Order details** page, enter the reference information for the agreement and the termination order, then select **Next**.
3. On the **Review order** page, review all selections. When done, select **Place order** to submit the termination order.&#x20;
