...
## CSP products <a href="#csp-products" id="csp-products"></a>
...
{% stepper %}
{% step %}
#### Creating a Microsoft organization tenant <a href="#step-1-creating-a-microsoft-organization-tenant" id="step-1-creating-a-microsoft-organization-tenant"></a>
...
{% step %}
#### Accepting the Microsoft Customer Agreement <a href="#step-2-accepting-the-microsoft-customer-agreement" id="step-2-accepting-the-microsoft-customer-agreement"></a>
...
{% step %}
#### Service provisioning and integration <a href="#step-3-service-provisioning-and-integration" id="step-3-service-provisioning-and-integration"></a>
...
{% step %}
#### Ongoing support and management <a href="#step-4-ongoing-support-and-management" id="step-4-ongoing-support-and-management"></a>
...
## Subscription states within the Marketplace <a href="#subscription-states-withing-the-softwareone-marketplace" id="subscription-states-withing-the-softwareone-marketplace"></a>
