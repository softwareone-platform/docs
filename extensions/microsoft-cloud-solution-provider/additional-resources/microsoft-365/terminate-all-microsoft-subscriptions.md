...
Make sure that the agreement you want to terminate is currently active. Agreements in any other state cannot be terminated.
...
2. **Order details** – Provide reference details, like additional IDs or notes, and select **Next**.
