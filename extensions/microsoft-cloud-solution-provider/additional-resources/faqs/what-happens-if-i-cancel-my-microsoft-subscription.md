...
For details on how to cancel individual subscriptions within your agreement, see [Terminate Subscriptions](../tutorials-and-videos/microsoft-365/terminate-microsoft-subscription.md). If you want to cancel the agreement altogether, see [Terminate All Microsoft Subscriptions](../tutorials-and-videos/microsoft-365/terminate-all-microsoft-subscriptions.md).
