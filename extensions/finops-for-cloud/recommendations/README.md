...
### <mark style="color:green;">Data sources</mark> <a href="#force-check-and-check-time" id="force-check-and-check-time"></a>
...
### <mark style="color:green;">Categories and applicable services</mark> <a href="#filtering" id="filtering"></a>
...
### <mark style="color:green;">More options</mark> <a href="#settings" id="settings"></a>
