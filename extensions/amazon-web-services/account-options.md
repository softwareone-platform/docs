...
1. Your unique root user email address. It's important to use a corporate alias instead of your personal email address. This ensures your company retains control of accounts even if an employee leaves.
2. AWS account name.
