...
When you are ordering AWS services through the SoftwareOne Marketplace, you can either create a new AWS account or transfer the billing of your Management Account to SoftwareOne.&#x20;
...
The following video describes how to create, secure, and configure an AWS account before onboarding it to SoftwareOne.&#x20;

{% embed url="https://www.youtube.com/watch?v=vQ630-OkcbQ" %}
Watch this video guide to learn how to create, secure, and prepare an AWS account for onboarding to SoftwareOne.
{% endembed %}
...
After signing in to your newly created AWS account:
...
After completing these steps, copy the 12-digit AWS Organizations management account ID and return to the SoftwareOne Marketplace purchase flow to continue onboarding. For instructions, see [Sign up for a new AWS account](tutorials/sign-up-for-new-aws-account.md).
