...
<figure><img src="../../../.gitbook/assets/auto_renewal.png" alt=""><figcaption><p>The Configure option on the subscription details page.</p></figcaption></figure>
{% endstep %}
...
1. **Auto-renewal** – Choose **Disable**, then select **Next**.&#x20;
