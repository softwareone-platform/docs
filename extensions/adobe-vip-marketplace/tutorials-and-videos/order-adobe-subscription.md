...
To order a subscription via the Marketplace Platform, you must have an agreement. An agreement is a contractual relationship between a seller, a buyer, and a licensee. Therefore, each ordered subscription is part of an agreement.&#x20;
...
2. **Select licensee** - Choose if you want to use an existing licensee or create a new one. In this tutorial, we'll select an existing licensee. You can add a new licensee by selecting **Add licensee**. For instructions, see [Create Licensees](../../../modules-and-features/settings/licensees/create-licensees.md).&#x20;
3. **Create agreement** - Choose **Create account** to create a new account with Adobe, then select **Next**.&#x20;
4. **Agreement details** - Provide the following information, then select **Next**:
   * Your company name.&#x20;
...
5.  **Items** - Do the following:
    ...
    1. Choose the items you want to order. You can select multiple items from the list. When done, select **Add items**.
    ...
    b. Review and adjust the quantity of items as necessary.&#x20;
