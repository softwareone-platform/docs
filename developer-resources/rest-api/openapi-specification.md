...
You can download the OpenAPI 3.0 specification of Marketplace Platform REST API and use it with tools of your choice.&#x20;
...
* Task API - Manage and track long-running task, including creating tasks, retrieving results, managing status, and viewing detailed task logs.
