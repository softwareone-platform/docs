...
</code></pre></td></tr><tr><td>message</td><td>string</td><td><p>Invitation message.  </p><p>Example: <code>To proceed with granting you access to the Adobe Acrobat extension, please use the invitation link. You’ll be prompted to redeem a code during installation – this is part of our approval process to ensure secure setup.</code></p></td></tr><tr><td>validity</td><td></td><td><p>Invite validity period. Allowed values are:</p><ul><li>7d - seven days</li><li>1m - one month</li><li>3m - tree months</li><li>1y - one year</li></ul><p></p><p>Example:</p><pre class="language-json" data-overflow="wrap" data-line-numbers><code class="lang-json">{
  "period": "1m"
}
