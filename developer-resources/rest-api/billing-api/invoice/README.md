...
</code></pre></td></tr><tr><td>billingType</td><td><code>enum</code></td><td>The type of billing. Possible values are <code>Automated</code> or <code>Manual</code>. The values are based on the source of the linked statement, such as a manual upload or journal (automated).</td></tr><tr><td>status</td><td><code>enum</code></td><td>The status of the invoice. Possible values are: <code>Issued</code>, <code>Paid</code>, or <code>Overdue</code>.</td></tr><tr><td>currency</td><td><code>string</code></td><td><p>The invoice currency.</p><p>Example: EUR</p></td></tr><tr><td>client</td><td><a href="../../accounts-api/account/"><code>account</code></a></td><td><p>A reference to the Client Account object.</p><p>Example:</p><pre class="language-json" data-overflow="wrap" data-line-numbers data-full-width="true"><code class="lang-json">{
  "id": "ACC-1234-4444",
  "name": "Best LLC",
