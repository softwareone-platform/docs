...
For more details and advanced patterns, see [RQL advanced tips](https://github.com/softwareone-platform/docs/blob/master/developer-resources/rest-api/rql-advanced-tips.md).
