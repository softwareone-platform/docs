...
3. Select **Add another condition** to open a menu of conditions.&#x20;
...
1. Go to **Marketplace** > **Orders**.
2. Select the <img src="../../../.gitbook/assets/icon_filter.png" alt="" data-size="line"> **Filter** icon, then define the conditions:
