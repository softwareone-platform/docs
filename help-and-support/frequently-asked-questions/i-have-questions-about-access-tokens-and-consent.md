...
3. Modify the default Reader role to the Tag Contributor role (and vice versa) during the Change Access process. For more information, see [Sync your tags to Azure](../../set-up/cloud-tenant-setup/azure-onboarding/adding-azure-enterprise-agreement-ea-account.md#syncing-your-tags-to-azure).
