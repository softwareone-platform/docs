...
We've removed the Search bar and the icons for the shopping cart, [Reports](../../modules/other-tools/reports/), and Notifications from the header. You can now access these pages directly from the navigation menu.
