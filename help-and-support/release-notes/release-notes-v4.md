...
We've also updated the platform's navigation menu to include a new **Billing** module, which gives you easy access to your [statements](../../modules-and-features/marketplace/billing/statements.md).
