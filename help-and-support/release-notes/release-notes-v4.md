...
You can find the **Spotlight** feature on the **Home** page, and it can also be accessed by selecting the spotlight icon <img src="../../.gitbook/assets/icon_pending_actions.png" alt="" data-size="line"> in the status bar.

<figure><img src="../../.gitbook/assets/spotlight.png" alt=""><figcaption><p>Spotlight widget</p></figcaption></figure>

If you have saved orders, those orders are spotlighted so you can manage them easily. Similarly, subscriptions that are nearing expiration are also shown so you can take timely action. To learn more, see [View Object Spotlight](../../marketplace-platform/getting-started/interface/view-pending-tasks.md).&#x20;

## New Order Status

We have introduced a new status called **Quoted** for orders in the Marketplace platform.&#x20;

This status is used when you save an order to place it at a later time. The new status is introduced to help you identify orders you may have intentionally saved, and it applies to purchase orders, change orders, and termination orders.&#x20;
...
<figure><img src="../../.gitbook/assets/release_notes_v4_catalog-vendors.png" alt=""><figcaption><p>SoftwareOne Public Catalog</p></figcaption></figure>

## Search Query in Data Grids

Data grids now include a new condition called Search Query, which is available in the <img src="data:image/png;base64," alt="<svg xmlns=&#x22;http://www.w3.org/2000/svg&#x22; height=&#x22;24px&#x22; viewBox=&#x22;0 -960 960 960&#x22; width=&#x22;24px&#x22; fill=&#x22;#5f6368&#x22;><path d=&#x22;M400-240v-80h160v80H400ZM240-440v-80h480v80H240ZM120-640v-80h720v80H120Z&#x22;/></svg>" data-size="line">**Filter** option. This new condition allows you to enter a search term, which is then used to find matching records across other filter conditions, such as orders, agreements, and more.
