---
description: Learn how to use the mobile app version of the SoftwareOne Marketplace.
---
...
If you have trouble signing in, see [Sign-in & Security](../mobile-app-faqs.md#sign-in-and-security) in the [Mobile App FAQs](../mobile-app-faqs.md).
...
If you want to update your profile, use the web version of the platform: [https://portal.platform.softwareone.com/](https://portal.platform.softwareone.com/).
...
1. Tap your profile icon in the upper-right corner.
2. Under **Your Profile**, tap your user name.
3. On the **User Settings** page, select **Sign out**.
