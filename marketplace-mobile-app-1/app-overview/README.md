...
The app supports a subset of core platform features optimized for mobile use. Within the mobile app, you can view:

* Specific objects that may need your attention, such as expiring subscriptions, orders querying for additional information, and more.
...
* **More** - Access additional objects, such as agreements, credit memos, programs, enrollments, and more.
...
At the top, you'll find your profile menu. Select this menu to view your profile or switch accounts. You can also view your favorite and recently accessed accounts.

### Next steps

If you’ve received your invitation email, see  [Get Started with the App](get-started-with-the-app.md) to begin.
