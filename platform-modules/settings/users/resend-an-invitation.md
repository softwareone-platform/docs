...
Follow the steps in this topic only if you want to resend a previously generated invite. For example, if the person didn't receive the original invitation.&#x20;
...
2. Navigate to the **Users** page (**Settings** > **Users**) and find the user you want to reinvite.
3. Click the actions icon (**•••**) for the user.
4. To resend the invitation email, click **Resend invitation link**. A message is displayed when your invitation is sent successfully.
