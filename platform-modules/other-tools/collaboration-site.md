...
The Collaboration Site can be accessed by navigating to the [user profile menu](../../getting-started/platform-overview/interface.md#user-profile-menu) and then selecting **Collaboration Site**.
