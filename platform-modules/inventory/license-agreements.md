...
To access your license agreements, navigate to the [main menu](../../platform-basics/platform-interface/#main-menu) of the Client Portal and select **Inventory** > **License agreements**.&#x20;
