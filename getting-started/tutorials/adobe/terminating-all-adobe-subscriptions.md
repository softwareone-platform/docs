...
# Terminating All Adobe Subscriptions

The only way to terminate all Adobe subscriptions in an agreement is by terminating the agreement altogether. This tutorial shows how you can create a termination order for an existing agreement.

## Prerequisites

Make sure that the agreement you want to terminate is **Active**.&#x20;
...
2. Enter the reference information as needed and click **Next**. Note that it's optional to provide these details.
