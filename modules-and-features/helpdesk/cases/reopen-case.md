...
3. Select the required case ID.&#x20;
4. In the case details pane, select the actions icon (**•••**), then choose **Reopen**.
5. Confirm that you want to open the case.&#x20;
...
3. Select the case you want to reopen.&#x20;
4. Select the actions icon (**•••**) in the chat window, then under **Case**, choose **Reopen**.
5. Confirm that you want to open the case.&#x20;
