...
To invite participants to a chat:
...
1. On the **Chats** page, open the desired chat conversation.
2. Select the actions icon (**•••**), then choose **Edit**.
...
1. On the **Chats** page, open the desired chat conversation.
2. Select the actions icon (**•••**), then choose **Leave**.
3. In the **Leave chat** confirmation, select **Leave** to confirm.
