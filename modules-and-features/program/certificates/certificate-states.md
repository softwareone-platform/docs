...
A certificate can be in one of these states: **Pending**, **Active**, **Expired**, **Updating**, or **Terminated**. The following diagram shows the transitions between these states:
