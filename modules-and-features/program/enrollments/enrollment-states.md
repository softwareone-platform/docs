---
description: Learn about the different states of an enrollment.
---

# Enrollment states

Enrollment is the process of registering for a program.&#x20;

An enrollment can be in one of these states: **New**, **Processing**, **Querying**, **Complete**, or **Failed**. The following diagram shows the transitions between these states:
