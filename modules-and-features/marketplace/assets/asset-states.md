---
description: Learn about the different states of an asset.
---
...
An agreement can be in one of these states: **New**, **Draft**, **Active**, or **Terminated**. The following diagram shows the transitions between these states:

<figure><img src="../../../.gitbook/assets/state-diagram-asset.png" alt=""><figcaption><p>The state transition diagram of an asset.</p></figcaption></figure>
