...
To view your one-time purchased items, navigate to the **Marketplace** > **Assets** page. Your list of assets is also displayed on the **Assets** tab within the [order details](../orders/#order-details) and [agreement details](../agreements/#subscription-details) pages.
...
{% content-ref url="rename-asset.md" %}
[rename-asset.md](rename-asset.md)
{% endcontent-ref %}
