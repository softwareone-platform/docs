...
3. In the **Auto-renewal** step, choose the required auto-renewal status, then select **Next**.&#x20;
...
5. Review the details. When done, select **Place order** to submit your order.&#x20;
...
When the order completes, the agreement's status changes back to **Active**, and the new auto-renewal status is reflected on the subscription's details page.
