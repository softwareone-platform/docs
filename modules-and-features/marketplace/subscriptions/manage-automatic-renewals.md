...
3. On the **Auto renewal** page, choose **Enable** or **Disable** depending on the current renewal status and select **Next**.&#x20;
...
When the configuration order has been placed, your agreement's status changes from **Active** to **Updating**. Once the order has been completed, the agreement's status changes back to **Active**, and the new auto-renewal status is reflected on the subscription's details page.
