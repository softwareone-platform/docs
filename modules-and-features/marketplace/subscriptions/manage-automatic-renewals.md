...
When the configuration order has been placed, your agreement's status changes from **Active** to **Updating**. When the order has been completed, the agreement's status changes back to **Active**, and the new auto-renewal status is reflected on the subscription's details page.
