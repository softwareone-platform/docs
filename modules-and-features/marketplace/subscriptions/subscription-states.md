...
A subscription can be in one of these states: **Draft**, **Deleted**, **Terminating**, **Active**, **Updating**, **Terminated**, or **Expired**. The following diagram shows the transitions between these states:
