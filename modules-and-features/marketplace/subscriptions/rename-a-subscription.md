---
description: Rename your active or updating subscriptions.
---
...
Subscriptions can be renamed using the **Rename** option on the subscription details page. Only the subscriptions in the **Active** and **Updating** states can be renamed.
...
4. In the **Rename** dialog, enter the new name. Select **Save**.
