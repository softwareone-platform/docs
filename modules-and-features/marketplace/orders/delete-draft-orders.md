...
2. Select the order you want to delete. If there are several orders, use [filters ](../../../marketplace-platform/getting-started/marketplace-for-clients/how-to-filter-your-orders.md)to find the required order.
...
<div data-with-frame="true"><figure><img src="../../../.gitbook/assets/image (955).png" alt=""><figcaption><p>Delete option in the upper right</p></figcaption></figure></div>

4. In the **Delete order** confirmation, select **Delete** to confirm the action. The order is deleted, and its status changes to **Deleted** on the **Orders** page.
