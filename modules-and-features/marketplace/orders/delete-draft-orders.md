...
4. In the **Delete order** confirmation, select **Delete** to confirm the action. Your order is deleted, and the status of the order changes to **Deleted** on the **Orders** page.
