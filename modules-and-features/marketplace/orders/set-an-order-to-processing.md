...
2. Select the required purchase order in the **Querying** state. If you have several orders, use the [search bar](../../../marketplace-platform/getting-started/interface/#search) or [filters](../../../marketplace-platform/getting-started-1/marketplace-for-clients/how-to-filter-your-orders.md) to quickly locate your order.
