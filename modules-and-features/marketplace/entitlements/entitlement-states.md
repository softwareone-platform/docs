...
An entitlement can be in one of these states: **Active** or **Terminated**. These states indicate whether the entitlement is currently valid or has been cancelled in the Marketplace Platform.
