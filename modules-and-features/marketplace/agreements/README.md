...
An agreement establishes the terms and conditions of a transaction in the Marketplace.

It defines the relationships among buyers, sellers, and licensees, and is required for placing orders and creating subscriptions.&#x20;

Marketplace agreements can include one or more subscriptions. Each subscription contributes to the total agreement value based on its type (quantity‑based or usage‑based). For information on these subscription types, see [Subscription models](../subscriptions/#subscription-models).&#x20;

### Agreements page

The **Agreements** page displays a list of your agreements and allows you to manage them.

To open the page, choose **Marketplace** > **Agreements** from the main menu.&#x20;
...
On the agreements page, you can view various details for an agreement, including the agreement ID, entities (such as buyers and sellers) for the agreement, estimated agreement value, status, and more.&#x20;
