...
4. In the **Terminate agreement** wizard, do the following:
   1. On the **Items** page, make sure the new quantity is displayed as 0. Then, select **Next**.
