...
2. (Optional) Use filters to find the agreement to terminate.
...
When the order has been processed and all subscriptions within the agreement are canceled, the status changes to **Terminated**.
