...
An agreement can be in one of these states: **Draft**, **Deleted**, **Provisioning**, **Failed**, **Active**, **Updating**, or **Terminated**. The following diagram shows the transitions between these states:
