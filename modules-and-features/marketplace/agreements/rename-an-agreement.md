...
4. In the **Rename** dialog, enter the new name and select **Save**. The agreement name is updated and displayed across all pages featuring the agreement within the platform.&#x20;

<div data-with-frame="true"><figure><img src="../../../.gitbook/assets/Rename (2).png" alt=""><figcaption><p>Use the Raname dialog to edit the name of an agreement.</p></figcaption></figure></div>
