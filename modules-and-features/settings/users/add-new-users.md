...
1. Navigate to the **Users** page. Then, select **Add** to open the **Add user** page.&#x20;

<figure><img src="../../../.gitbook/assets/image (910).png" alt=""><figcaption><p>Add user page</p></figcaption></figure>

2. On the **User details** page, enter the following details and select **Next**:
