...
4. In the **Delete API token** dialog, confirm you want to delete the token. A message is displayed stating that the API token is deleted successfully.&#x20;
