...
3. Select **Next**. In the **Modules** step, select the platform modules that the token allows access to. When done, select **Next**. Note that only the modules that SoftwareOne has enabled for your account are displayed on the page.&#x20;

<div data-with-frame="true"><figure><img src="../../../.gitbook/assets/image (991).png" alt=""><figcaption><p>The Module selection step when adding an API token.</p></figcaption></figure></div>
