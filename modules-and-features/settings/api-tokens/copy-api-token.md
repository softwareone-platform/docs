...
1. Navigate to the **API tokens** page. Then, find the token you want to copy.
2. Select the token to open its details page.
...
3. From the **General** tab, do the following as needed:
