...
Notification emails can exist in these states: **Queued**, **Discarded**, **Sent**, **Failed**, **Bounced**, or **Complained**. The following diagram shows the transitions between these states:
