...
4. In the **Enable** dialog, add your comments in the **Notes** field and then select **Enable** to confirm the action. A confirmation message is displayed, and all notification emails for the category are immediately re-enabled.
