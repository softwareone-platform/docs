...
{% content-ref url="notification-states.md" %}
[notification-states.md](notification-states.md)
{% endcontent-ref %}

{% content-ref url="configure-recipients.md" %}
[configure-recipients.md](configure-recipients.md)
{% endcontent-ref %}

{% content-ref url="enable-or-disable-categories.md" %}
[enable-or-disable-categories.md](enable-or-disable-categories.md)
{% endcontent-ref %}

{% content-ref url="view-notification-messages.md" %}
[view-notification-messages.md](view-notification-messages.md)
{% endcontent-ref %}

{% content-ref url="edit-notification-settings.md" %}
[edit-notification-settings.md](edit-notification-settings.md)
{% endcontent-ref %}
